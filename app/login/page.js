            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700 p-12 items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 text-white max-w-md">
                    <div className="mb-8">
                        ...
                        <h1 className="text-4xl font-bold mb-4">Welcome Back to JS Shop</h1>
                    ...
                    <div className="space-y-4 mt-12">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-blue-100">Save up to 50% on selected items</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            <div className="w-12 h-12 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-blue-100">Get your orders delivered quickly</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            <div className="w-12 h-12 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
